                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-12 mt-24">
                            <div className="bento-card">
                                ...
                                <p className="text-seamless font-bold leading-relaxed">By accessing Fileflow, you agree to engage with the system as a professional creator. The use of the platform for distributing malicious code or illegal content is prohibited and will result in immediate identity revocation.</p>
                            </div>
                            ...
                            <div className="bento-card">
                                ...
                                <p className="text-seamless font-bold leading-relaxed">You retain full ownership of all data pushed through our pipes. Fileflow Systems acts only as the neutral transmission layer. We do not index, search, or backup your files beyond the specified expiry period.</p>
                            </div>
                        </div>
                    </div>
                </section>
